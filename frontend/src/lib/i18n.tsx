...
const messages = {
  ...
  enabledSourcesLabel: "Data Source Switches",
  enabledSourcesDesc: "Disabled sources will not be called by the agent. Turn off any source you don't have access to.",
  srcTushare: "Tushare",
  srcTushareDesc: "A-share, futures, fund, macro (requires token)",
  srcAkshare: "AKShare",
  srcAkshareDesc: "A-share, US, HK, futures, macro, forex (free)",
  srcYfinance: "yfinance",
  srcYfinanceDesc: "US stocks, HK stocks, ETFs (free, needs Yahoo Finance access)",
  srcOkx: "OKX",
  srcOkxDesc: "Crypto — OKX exchange (free)",
  srcCcxt: "CCXT",
  srcCcxtDesc: "Crypto — 100+ exchanges (free)",
  ...
  tushareUrl: "Tushare API URL",
  tushareUrlPlaceholder: "Leave blank to use default (api.waditu.com)",
  tushareUrlHint: "Override the Tushare API endpoint, e.g. for a private mirror or proxy.",
  clearTushareUrl: "Clear saved Tushare URL",
