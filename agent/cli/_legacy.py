...
def _run_agent(
    ...
    *,
    ...
    return _run_with_graceful_cancel(agent, prompt, history, no_rich=no_rich, session_id=session_id)
...
def _run_with_graceful_cancel(
    ...
    *,
    ...
    Args:
        ...
        session_id: Optional session identifier for memory attribution.
